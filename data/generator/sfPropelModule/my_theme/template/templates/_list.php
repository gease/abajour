<div class="sf_admin_list">
  ...
  [?php else: ?]
    <table cellspacing="0">
      <thead>
        <tr>
<?php if ($this->configuration->getValue('list.numbering')): ?>
    <th class="sf_admin_list_th_numbering">[?php echo __('#') ?]</th>
<?php endif;?>
...
<?php endif; ?>
      ...
      <tfoot>
        <tr>
          <th colspan="<?php echo count($this->configuration->getValue('list.display')) + ($this->configuration->getValue('list.object_actions') ? 1 : 0) + ($this->configuration->getValue('list.batch_actions') ? 1 : 0) + ($this->configuration->getValue('list.numbering') ? 1 : 0) ?>">
...
<?php if ($this->configuration->getValue('list.numbering')): ?>
    <td class="sf_admin_list_numbering">[?php echo $i+$pager->getFirstIndice()-1 ?]</td>
<?php endif;?>
<?php if ($this->configuration->getValue('list.batch_actions')): ?>
...
<?php endif; ?>
            [?php include_partial('<?php echo $this->getModuleName() ?>/list_td_<?php echo $this->configuration->getValue('list.layout') ?>', array('<?php echo $this->getSingularName() ?>' => $<?php echo $this->getSingularName() ?>, 'i'=>$i+$pager->getFirstIndice()-1)) ?]
<?php if ($this->configuration->getValue('list.object_actions')): ?>
