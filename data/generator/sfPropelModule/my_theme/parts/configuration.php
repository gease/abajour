 ...
 * @author     ##AUTHOR_NAME##
 * @version    SVN: $Id: configuration.php 162 2009-10-06 16:56:22Z я $
 */
...
<?php unset($this->config['list']['peer_count_method']) ?>
  ...
  {
    parent::compile();
    $this->configuration['list']['numbering'] = $this->getListNumbering();
    $this->configuration['list']['ordering'] = $this->getListOrdering();
  }
}
