...
<?php endforeach; ?>
  ...
  public function getListNumbering()
  {
    return <?php echo $this->asPhp(isset($this->config['list']['numbering'])? $this->config['list']['numbering']:false) ?>;
    <?php unset ($this->config['list']['numbering']) ?>
  }
  
  public function getListOrdering()
  {
    <?php if (isset($this->config['list']['ordering'])): ?>
    return <?php echo $this->asPhp($this->config['list']['ordering']) ?>;
    <?php else: ?>
    return array();
    <?php endif; ?>
    <?php unset($this->config['list']['ordering']) ?>
  }
